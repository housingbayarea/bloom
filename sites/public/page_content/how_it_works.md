...
* ## Check Eligibility
  ...
  * Seniors: These may include apartments designated as “senior” housing for individuals over a particular age (such as 55, 62, or 70). 
  * People with Developmental Disabilities: Whole communities, or a percentage of units within a property, may be designated for people with disabilities. 
  ...
  * Household: A “household” can be just one person or two or more persons. All household members that will be living in the home must be included in the application. 
...
* ## Prepare for Next Steps
  ...
  Some examples of financial documents that property managers may ask for at the time of your interview include: employment or income information (work paystubs, social security letter, checking/savings account statements, alimony/child support letters), tax statements (W-2 forms, tax returns), public benefits (rental assistance voucher, veterans benefits), liabilities (credit card statements) and assets (401k/IRA statements) 

  ##### Personal Documents:

  Some examples of personal documents include the following forms of identification: Driver’s license/state ID, birth certificate, social security, and passport. 

  If you do not have or do not know how to obtain these documents, you can get assistance from a housing counselor, who can help you gather your documents.
