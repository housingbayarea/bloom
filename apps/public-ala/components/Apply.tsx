...
import { Button, LinkButton, SidebarAddress, openDateState, t } from "@bloom-housing/ui-components"
        ...
        {!openDateState(listing) ||
          (openDateState(listing) &&
            ...
            ((listing.acceptingOnlineApplications && (
              <>
                <a className="button is-filled w-full mb-2 is-filled" href={onlineApplicationUrl}>
