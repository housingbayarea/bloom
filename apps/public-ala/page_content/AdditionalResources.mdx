...
<RenderIf language="default">
  ...
  <InfoCard title="Alameda County Boost - Alameda County's Down Payment Loan Assistance Program" externalHref="https://www.acboost.org/">  

  Provide down payment assistance loans to eligible, middle-income, first-time homebuyers.

  </InfoCard>

  <InfoCard title="Alameda County Housing Secure - Alameda County's Anti-Displacement Program" externalHref="https://www.centrolegal.org/achousingsecure/">  

  Provides free legal services and emergency financial assistance to tenants and homeowners.
  </InfoCard>

  <InfoCard title="Renew Alameda County - Alameda County's Housing Preservation Loan Program" externalHref="https://www.renewac.org/">
  ...
  <InfoCard title="Berekley Housing Authority" externalHref="https://www.cityofberkeley.info/bha/">
  </InfoCard>
